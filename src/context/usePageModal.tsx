...
const PageModalContext = createContext<PageModalContextType | undefined>(
  undefined,
)

const PageModalProvider = ({ children }: { children: ReactNode }) => {
  const [isOpen, setIsOpen] = useState(false)
  const [renderPageModal, setRenderPageModal] = useState<
    ReactNode | undefined
  >()
  ...
  return (
    <PageModalContext.Provider
      value={{ isOpen, renderPageModal, openPageModal, closePageModal, render }}
    >
      {children}
    </PageModalContext.Provider>
  )
